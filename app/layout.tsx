...
export const metadata: Metadata = {
  ...
  description:
    "Slash blocks your shopping apps when you overspend. Set a weekly cap, connect your bank, and Slash blocks the apps you chose on your iPhone. Join the waitlist.",
}
